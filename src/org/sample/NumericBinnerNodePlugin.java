 ...
 * @author sac hin
 */
public class NumericBinnerNodePlugin extends Plugin {
    // The shared instance.
    private static NumericBinnerNodePlugin plugin;

    /**
     * The constructor.
     */
    public NumericBinnerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NumericBinnerNodePlugin getDefault() {
        return plugin;
    }
